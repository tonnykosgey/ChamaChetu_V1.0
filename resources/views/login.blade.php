...
<html lang="en">
  ...
  <body class="login-body">
    ...
    <div class="container-fluid login-wrapper">
        <div class="login-box">
            <h1 class="text-center mb-5"><i class="fa fa-group text-primary"></i> Chama Chetu</h1>
            <div class="row">
                <div class="col-md-6 col-sm-6 col-12 login-box-info">
                    ...
                    <p class="text-center"><a href="/register" class="btn btn-light">Register here</a></p>
                </div>
                <div class="col-md-6 col-sm-6 col-12 login-box-form p-4">
                    ...
                    <form action="" class="mt-2">
                        ...
                        <div class="form-group">
                            <button class="btn btn-theme btn-block p-2 mb-1"><a href="/dashboard" class="text-white">Login</a></button>
